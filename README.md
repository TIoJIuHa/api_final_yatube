...
В проекте реализован REST API и CRUD для основных моделей проекта социальной сети [Yatube](https://github.com/TIoJIuHa/hw05_final).
...
[Полная документация по API (redoc.yaml)](yatube_api\static\redoc.yaml)
